/**
 * This function splits text from innerHTML based on regex. Then, it wrap sparated words with <div> except <br>
 * Finally, it returns array of div
 * @param {HTML element} element
 * @param {string} split This is separator for text (regex)
 * @return {Array.<HTML element>} Array of div html element
 */
export default function textSplit(element, split) {
...
/**
 * This function will wrap passed argument with <div> if passed argument is not empty, space, or <br>
 * @params {string} line It is words that are separated by seprator
 * @return {string} it is either '', ' ', <br> , or <div>line<div>
 */
